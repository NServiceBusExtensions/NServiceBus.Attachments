...
namespace NServiceBus.Attachments.Sql
{
    ...
    public interface IPersister
    {
        ...
        Task SaveStream(SqlConnection connection, SqlTransaction transaction, string messageId, string name, DateTime expiry, Stream stream, CancellationToken cancellation = default);
